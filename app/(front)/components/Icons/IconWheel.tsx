...
export const IconWheel: React.FC<IconWheelProps> = ({ size = 32, isActive }) => {
    const color = isActive ? 'var(--accent-color)' : 'white';

    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none">
            <style type="text/css">{`.IconWheel{transition:stroke 0.2s ease;}`}</style>
            <path
